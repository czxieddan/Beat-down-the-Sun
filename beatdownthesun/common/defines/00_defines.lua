...
NDiplomacy = {
	...
	TRUCE_PERIOD_AFTER_KICKING_FROM_FACTION = 1,				-- Truce period after kicking someone from faction in days.
	NUM_DAYS_TO_ENABLE_KICKING_NEW_MEMBERS_OF_FACTION = 18000,			-- Number of days before being able to kick a new member of faction
	...
	ASSUME_FACTION_LEADERSHIP_PP_COST = 2001,				-- Political power cost to assume faction leadership
	...
	FACTION_LEADERSHIP_CHANGE_ALERT_THRESHOLD = 100,		-- Threshold for showing an alert when a faction member is close to being able to assume leadership of the faction that a player currently leads.
...
NAI = {
	...
	DIPLOMACY_FACTION_Economic_Interventionism_PENALTY = 50,	-- Neutral nations have a separate penalty, not wanting to get involved at all, rather than caring much about the difference in ideology
	...
	CALL_ALLY_Market_Capitalism_DESIRE = 50,			-- Desire to call ally added for Market_Capitalism AI
	...
	JOIN_ALLY_Market_Capitalism_DESIRE = 50,			-- Desire to join ally added for Market_Capitalism AI
	...
	ACCESS_SCORE_FOR_Market_Capitalism_COUNTRIES = 500,				-- democracies gives each other access if they have a common enemy
	...
	Market_Capitalism_AI_FACTION_KICKING_PLAYER_THREAT_DIFFERENCE = 6.0, -- World threat generation difference needed to kick a player from a Market_Capitalism faction
	BEFRIEND_FACTOR_FOR_KICKING_COUNTRIES = 7.5,		-- World threat difference addition per 100 befriend against a country, Market_Capitalism leaders will forgive allies if they are befriending them
